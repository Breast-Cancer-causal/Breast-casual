# -*- coding: utf-8 -*-
"""
Created on Sat Aug 28 08:50:41 2021
...
"""
Why logger_util?
Logger. Logger runs as an unattended background process that receives 
log messages from the OpenLog Framework and writes the messages to the 
file system. In addition to this primary use, the Logger can be configured 
to output in other ways, such as sending log messages to an e-mail system.
"""
import logging
